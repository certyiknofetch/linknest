...
1. Download from [HERE](https://chromewebstore.google.com/detail/linknest-cross-browser-bo/fdgdngoejembedbedpaajhgldiffmiee) | [HERE](https://github.com/certyiknofetch/linknest/blob/main/extension/linknest-chrome.zip) — or build `linknest-chrome.zip`
...
1. Download from [HERE](https://addons.mozilla.org/addon/linknest) | [HERE](https://github.com/certyiknofetch/linknest/blob/main/extension/linknest-firefox.zip) — or build `linknest-firefox.zip`
2. Extract to a folder
