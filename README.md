...
1. Download from [Store](https://chromewebstore.google.com/detail/linknest-cross-browser-bo/fdgdngoejembedbedpaajhgldiffmiee) | [Git](https://github.com/certyiknofetch/linknest/blob/main/extension/linknest-chrome.zip) — or build `linknest-chrome.zip`
...
1. Download from [Store](https://addons.mozilla.org/addon/linknest) | [Git](https://github.com/certyiknofetch/linknest/blob/main/extension/linknest-firefox.zip) — or build `linknest-firefox.zip`
2. Extract to a folder
